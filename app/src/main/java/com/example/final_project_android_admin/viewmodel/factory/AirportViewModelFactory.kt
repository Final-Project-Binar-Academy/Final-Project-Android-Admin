...
class AirportViewModelFactory(private val apiHelper: ApiHelper, private val pref: UserDataStoreManager) :
    ViewModelProvider.NewInstanceFactory() {

    @Suppress("UNCHECKED_CAST")
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(AirportViewModel::class.java)) {
            return AirportViewModel(AirportRepository(apiHelper), pref) as T
        }
